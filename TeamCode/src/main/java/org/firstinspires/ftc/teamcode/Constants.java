...
public class Constants {
    ...
    */
    ...
    // # of enc counts the motor needs after going through various gear ratios (if ratio is x:y, multiply by x/y)
    private static final Integer EncoderCountsPerRev = BaseEncoderCountsPerRev * 5;
    // In mm
